...
/*  Created On : 10-Aug-2017 1:47:26 PM 				*/
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Enrollment_Period]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Enrollment] DROP CONSTRAINT [FK_Enrollment_Period]
GO
...
ALTER TABLE [Enrollment] ADD CONSTRAINT [FK_Enrollment_Period]
